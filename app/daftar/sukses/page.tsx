        ...
        <div className="flex flex-col ">
          <div className="px-3 py-10 rounded-lg lg:px-6 form-pendaftaran-box ">
            <p className="my-1 text-xl text-gray-400 ">
              Terimakasih telah mendaftar pada Open Recruitment Staff HMIF UNSRI
              2024.
            </p>
            <br />
            <p className="my-1 text-xl text-gray-400 ">
              Calon staff wajib join grub whatsapp global, dinas pilihan 1, dan
              dinas pilihan 2. Silahkan bergabung pada group Whatsapp pada link
              berikut.
            </p>
            <br />
            <p className="my-1 text-xl text-gray-400 ">
