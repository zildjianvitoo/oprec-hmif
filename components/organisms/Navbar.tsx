...
const Navbar = () => {
  return (
    <div className="w-full h-[65px] fixed top-0 shadow-lg shadow-[#2A0E61]/50 bg-[#03001417] backdrop-blur-md z-50 px-3 lg:px-10">
      <div className="w-full h-full flex flex-row items-center justify-between m-auto lg:px-[10px]">
        <a
          href="#about-me"
          className="h-auto w-auto hidden md:flex flex-row items-center"
        >
          <Image
            src="/NavLogo.png"
            alt="logo"
        ...
        <div className="w-[500px] mx-auto h-full flex flex-row items-center justify-between md:mr-20">
